...
// AlternativeBubbleSort function implements alternative bubble sort algorithm
func AlternativeBubbleSort(arr []int) ([]int, int) {
	var (
		n          = len(arr)
		sorted     = false
		iterations = 0
...
// Test function tests BubbleSort
...
func Test(values []int) {
	...
	res2, iterations2 := AlternativeBubbleSort(values[:])
